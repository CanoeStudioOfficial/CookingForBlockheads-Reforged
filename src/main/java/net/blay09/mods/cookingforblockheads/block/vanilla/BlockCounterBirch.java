...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCounterBirch;
...
public class BlockCounterBirch extends BlockCounter {

    public static final String name = "counter_birch";
