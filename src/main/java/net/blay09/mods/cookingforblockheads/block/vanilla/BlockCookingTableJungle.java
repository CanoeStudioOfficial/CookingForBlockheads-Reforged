...
public class BlockCookingTableJungle extends BlockCookingTable {

    public static final String name = "cooking_table_jungle";
    public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);

    public BlockCookingTableJungle(Material material) {
        super(material);
