...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCabinetDarkOak;
...
public class BlockCabinetDarkOak extends BlockCabinet {
    public static final String name = "cabinet_darkoak";
    public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);

    public BlockCabinetDarkOak(Material material) {
        super(material);
