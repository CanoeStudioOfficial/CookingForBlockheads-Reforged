...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCounterDarkOak;
...
public class BlockCounterDarkOak extends BlockCounter {

    public static final String name = "counter_darkoak";
