...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCounterOak;
...
public class BlockCounterOak extends BlockCounter {

    public static final String name = "counter_oak";
    public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);

    public static final PropertyEnum<ModelPass> PASS = PropertyEnum.create("pass", ModelPass.class);

    public BlockCounterOak(Material material) {
        super(material);
