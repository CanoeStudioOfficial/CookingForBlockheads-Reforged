...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCabinetOak;
...
public class BlockCabinetOak extends BlockCabinet {
    public static final String name = "cabinet_oak";
