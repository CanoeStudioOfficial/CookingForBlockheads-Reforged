...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCounterJungle;
...
public class BlockCounterJungle extends BlockCounter {

    public static final String name = "counter_jungle";
