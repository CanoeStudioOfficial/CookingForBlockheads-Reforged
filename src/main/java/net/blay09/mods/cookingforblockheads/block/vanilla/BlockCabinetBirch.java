...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCabinetBirch;
...
public class BlockCabinetBirch extends BlockCabinet {
    public static final String name = "cabinet_birch";
    public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);

    public BlockCabinetBirch(Material material) {
        super(material);
