...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCabinetJungle;
...
public class BlockCabinetJungle extends BlockCabinet {
    public static final String name = "cabinet_jungle";
    public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);

    public BlockCabinetJungle(Material material) {
        super(material);
