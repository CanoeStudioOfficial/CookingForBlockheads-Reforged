package net.blay09.mods.cookingforblockheads.block.vanilla;
...
public class BlockCookingTableOak extends BlockCookingTable {

    public static final String name = "cooking_table_oak";
    public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);

    public BlockCookingTableOak(Material material) {
        super(material);
    ...
    public static class BlockCornerAcacia extends BlockCorner {

        public static final String name = "corner_acacia";
        public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);

        public BlockCornerAcacia(Material material) {
            super(material);
    ...
    public static class BlockCornerBirch extends BlockCorner {

        public static final String name = "corner_birch";
        public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);

        public BlockCornerBirch(Material material) {
            super(material);
    ...
    public static class BlockCornerDarkOak extends BlockCorner {

        public static final String name = "corner_darkoak";
        public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);

        public BlockCornerDarkOak(Material material) {
            super(material);
    ...
    public static class BlockCornerJungle extends BlockCorner {

        public static final String name = "corner_jungle";
        public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);
    ...
    public static class BlockCornerOak extends BlockCorner {
    ...
    public static class BlockCornerSpruce extends BlockCorner {

        public static final String name = "corner_spruce";
        public static final ResourceLocation registryName = new ResourceLocation(CookingForBlockheads.MOD_ID, name);
