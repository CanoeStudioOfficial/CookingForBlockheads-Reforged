...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCounterAcacia;
...
public class BlockCounterAcacia extends BlockCounter {

    public static final String name = "counter_acacia";
