...
import net.blay09.mods.cookingforblockheads.tile.vanila.TileCabinetSpruce;
...
public class BlockCabinetSpruce extends BlockCabinet {
    public static final String name = "cabinet_spruce";
